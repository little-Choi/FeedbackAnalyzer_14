...
void Constants::init() {
    SENTIMENT_KEYWORDS[SENTIMENT_POSITIVE] = {
        ...
        u8"좋아요" // legacy: duplicate entries allowed (CO-04)
    };
...
std::vector<std::string> Constants::categoryNames() {
    // UI/display order (matches init() insertion order; std::map iter is lexicographic).
